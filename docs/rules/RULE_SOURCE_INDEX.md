...
| --- | --- | --- | --- | --- | --- | --- |
| `GOV-WARN-EXACT` | all beverages at or above 0.5% ABV | blocker | hard fail when exact text is provably wrong; review on uncertain extraction | `docs/presearch/2026-04-13-foundation.md`; `docs/reference/product-docs/ttb-product-spec-final.md`; `docs/reference/product-docs/ttb-implementation-roadmap-final.md` | planned | Exact text is the showcase requirement. |
| `GOV-WARN-FORMAT` | all beverages at or above 0.5% ABV | blocker | fail for deterministic format defects; review when boldness, separation, or continuity is uncertain | `docs/presearch/2026-04-13-foundation.md`; `docs/reference/product-docs/ttb-product-spec-final.md`; `docs/reference/product-docs/ttb-implementation-roadmap-final.md` | planned | Includes all-caps prefix, bold prefix, punctuation, continuity, and separation. |
