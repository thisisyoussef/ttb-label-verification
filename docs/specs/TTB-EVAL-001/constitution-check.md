...
- No persistence: satisfied; this story defines synthetic or sourced eval assets, machine-readable manifests, and checked-in run logs, not durable storage of user submissions.
