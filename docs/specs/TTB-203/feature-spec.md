...
3. Beverage type uses application input when supplied; otherwise it is inferred from extracted content, then falls back to the strict distilled-spirits default when still ambiguous.
