...
- Active Codex story: `TTB-210` local follow-up on `codex/TTB-210-anchor-field-priority`
...
| 7 | `TTB-204` | `TTB-002` | government warning validator and diff evidence | Codex | `done` | keep the packet, warning route, and eval note as the record of the warning-validation slice; 2026-04-19 local follow-up narrows uppercase/bold enforcement to the opening heading and removes the extra missing-language downgrade | none |
