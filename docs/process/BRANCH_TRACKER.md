...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `chore/TTB-WF-003-slim-ci-flow` | `TTB-WF-003` | `chore` | `draft-local` | slim CI and PR flow so local publish gates drive routine merges | - | `2026-04-18` | `2026-04-18` | `origin/main` | linked worktree: /Users/youss/Development/gauntlet/ttb-label-verification-wf-003-slim-ci |
