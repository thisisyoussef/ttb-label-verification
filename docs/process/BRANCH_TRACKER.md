...
| `codex/TTB-401-readme-doc-refresh` | `TTB-401` | `codex` | `draft-local` | refresh evaluator screenshots and strengthen README plus evaluator guide | - | `2026-04-19` | `2026-04-19` | `origin/main` | linked worktree: /Users/youss/Development/gauntlet/ttb-label-verification-ttb-401-doc-refresh |
