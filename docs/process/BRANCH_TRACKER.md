...
| `codex/TTB-000-review-animation-stability` | `TTB-000` | `codex` | `published` | remove unstable review-page row reordering motion and keep only local smooth state changes | - | `2026-04-19` | `2026-04-19` | `origin/main` | linked worktree: /Users/youss/Development/gauntlet/ttb-label-verification-review-animation-stability |
