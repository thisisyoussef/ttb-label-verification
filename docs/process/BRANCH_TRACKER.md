...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `archive/TTB-000-stash-salvage-bootscreen` | `TTB-000` | `archive` | `draft-local` | preserve BootScreen + MANUAL_TEST_SCRIPT.md rewrite + minor batch-UI polish from a stash salvaged during the 2026-04-19 branch consolidation; patch file in docs/archive/ | - | `2026-04-19` | `2026-04-19` | `origin/main` | remainder content stale against useAppToolbench refactor; reapply selectively when revisited |
...
| `codex/TTB-210-relevance-recovery-publish` | `TTB-210` | `codex` | `draft-local` | remove the intake quick-scan warning, let Verify run immediately, and defer non-label/readability messaging to the post-Verify result path | - | `2026-04-19` | `2026-04-19` | `origin/main` | isolated clean publish branch cut from origin/main; carries the single relevance-recovery commit |
...
| `codex/TTB-WF-003-merge-consolidation` | `TTB-WF-003` | `codex` | `ready-pr` | consolidate open TTB-204/TTB-210/TTB-304 follow-ups: wine-field reveal, eager refine, batch review-first wording and simple ETA, no-text OCR exit, Toolbench dual-image sample pack | #138 | `2026-04-19` | `2026-04-19` | `origin/main` | isolated consolidation worktree at /private/tmp/ttb-merge-consolidation; supersedes PRs #115 and #117 |
<!-- ACTIVE_BRANCHES:END -->
