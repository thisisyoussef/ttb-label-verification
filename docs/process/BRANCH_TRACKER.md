...
| `chore/TTB-WF-004-auto-prod-promotion` | `TTB-WF-004` | `chore` | `draft-local` | automate production promotion after verified staging deploy | - | `2026-04-20` | `2026-04-20` | `origin/main` | linked worktree: /Users/youss/Development/gauntlet/ttb-label-verification-wf-004-auto-prod-promotion |
