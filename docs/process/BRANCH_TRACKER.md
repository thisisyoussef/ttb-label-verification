...
| `codex/TTB-209-first-result-timeout` | `TTB-209` | `codex` | `draft-local` | bound slow review tails with an 8s first-result deadline and smarter fallback budget | - | `2026-04-23` | `2026-04-23` | `origin/main` | local implementation and verification in progress; first-result budget wiring, provider aborts, and deadline-aware fallback tests are green |
