...
| `codex/TTB-204-warning-golden-diagnostics` | `TTB-204` | `codex` | `draft-local` | split the real warning corpus by visibility, resolve exact-text vote contradictions, and soften unstable heading-format fails | - | `2026-04-19` | `2026-04-19` | `origin/main` | isolated clean worktree for warning behavior follow-up |
