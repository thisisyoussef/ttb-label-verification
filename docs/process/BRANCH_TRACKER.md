...
| `codex/TTB-WF-003-merge-consolidation` | `TTB-WF-003` | `codex` | `draft-local` | consolidate open TTB-204/TTB-210/TTB-304 follow-ups: wine-field reveal, eager refine, batch review-first wording and simple ETA, no-text OCR exit, Toolbench dual-image sample pack | - | `2026-04-19` | `2026-04-19` | `origin/main` | isolated consolidation worktree at `/private/tmp/ttb-merge-consolidation` |
<!-- ACTIVE_BRANCHES:END -->
