...
| `codex/TTB-210-refine-warning-guard` | `TTB-210` | `codex` | `draft-local` | prevent refine from replacing a correct government-warning review row with weaker warning evidence | - | `2026-04-20` | `2026-04-20` | `origin/main` | opened from origin/main |
