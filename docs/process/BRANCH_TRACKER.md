...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `chore/TTB-000-review-animation-closeout` | `TTB-000` | `chore` | `published` | close merged tracker row for review animation stability fix | - | `2026-04-19` | `2026-04-19` | `origin/main` | opened from origin/main |
| `chore/TTB-WF-002-reviewer-structure-pass` | `TTB-WF-002` | `chore` | `ready-pr` | organize server and scripts into reviewer-friendly folders | #159 | `2026-04-20` | `2026-04-20` | `origin/main` | linked worktree: /Users/youss/Development/gauntlet/ttb-label-verification-wf-002-reviewer-structure |
| `chore/TTB-WF-004-auto-prod-promotion` | `TTB-WF-004` | `chore` | `ready-pr` | automate production promotion after verified staging deploy | #160 | `2026-04-20` | `2026-04-20` | `origin/main` | linked worktree: /Users/youss/Development/gauntlet/ttb-label-verification-wf-004-auto-prod-promotion |
...
| `codex/TTB-000-batch-retry-hardening` | `TTB-000` | `codex` | `draft-local` | harden batch item retries with hidden first retry and visible retry state | - | `2026-04-20` | `2026-04-20` | `origin/main` | linked worktree: /Users/youss/Development/gauntlet/ttb-label-verification-batch-retry-hardening |
| `codex/TTB-000-results-left-panel-scroll` | `TTB-000` | `codex` | `ready-pr` | make the review results left rail scroll as one cohesive column instead of splitting sticky image and scrolling metadata | #171 | `2026-04-23` | `2026-04-23` | `origin/main` | opened from origin/main |
...
| `codex/TTB-204-warning-pass-floor` | `TTB-204` | `codex` | `draft-local` | retune warning exact-text pass floor for cola-cloud-all approved labels | - | `2026-04-20` | `2026-04-20` | `origin/main` | opened from origin/main |
| `codex/TTB-204-warning-tail-trim` | `TTB-204` | `codex` | `ready-pr` | stop treating unrelated trailing label copy after the canonical warning as allowed extra warning messaging | #172 | `2026-04-23` | `2026-04-23` | `origin/main` | opened from origin/main |
| `codex/TTB-209-first-result-timeout` | `TTB-209` | `codex` | `ready-pr` | bound slow review tails with an 8s first-result deadline and smarter fallback budget | #167 | `2026-04-23` | `2026-04-23` | `origin/main` | local implementation and verification in progress; first-result budget wiring, provider aborts, and deadline-aware fallback tests are green |
| `codex/TTB-304-toolbench-batch-load-restore` | `TTB-304` | `codex` | `ready-pr` | restore the missing Toolbench batch sample loader and verify deploy pickup | #169 | `2026-04-23` | `2026-04-23` | `origin/main` | opened from origin/main |
...
| `codex/TTB-304-toolbench-upload-tab-remove` | `TTB-304` | `codex` | `ready-pr` | remove the Toolbench Upload tab and verify deploy pickup | #170 | `2026-04-23` | `2026-04-23` | `origin/main` | opened from origin/main |
| `codex/TTB-401-demo-recorder` | `TTB-401` | `codex` | `ready-pr` | add a reproducible narrated product demo recorder and deterministic demo-mode helpers for single and batch walkthroughs | #156 | `2026-04-20` | `2026-04-20` | `origin/main` | opened from origin/main |
| `codex/TTB-401-demo-recorder-ci-fix` | `TTB-401` | `codex` | `ready-pr` | make the demo recorder typecheck in clean CI without relying on an undeclared playwright install | #158 | `2026-04-20` | `2026-04-20` | `origin/main` | opened from origin/main |
...
| --- | --- | --- | --- | --- | --- | --- |
| `codex/TTB-000-cola-pack-loader-parity` | `TTB-000` | `codex` | `merged` | make BatchUpload Load COLA sample pack use the same full-pack loader behavior as Toolbench | `2026-04-20` | merged via PR #154 |
| `codex/TTB-204-warning-marker-repair` | `TTB-204` | `codex` | `merged` | repair dropped (1)/(2) warning markers, soften warning mismatch review copy/icon, and route Toolbench batch sample loads through the live dual-image pack | `2026-04-20` | merged via PR #161 |
| `codex/TTB-210-refine-warning-guard` | `TTB-210` | `codex` | `merged` | prevent refine from replacing a correct government-warning review row with weaker warning evidence | `2026-04-20` | merged via PR #163 |
