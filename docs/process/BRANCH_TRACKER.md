...
| `codex/TTB-204-bold-heading-review` | `TTB-204` | `codex` | `draft-local` | keep bold-only government warning heading misses in review so uncertain styling calls do not hard-fail the label | - | `2026-04-19` | `2026-04-19` | `origin/main` | isolated worktree for post-merge TTB-204 heading-confidence follow-up |
