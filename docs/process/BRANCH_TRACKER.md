...
| `codex/TTB-000-results-left-panel-scroll` | `TTB-000` | `codex` | `draft-local` | make the review results left rail scroll as one cohesive column instead of splitting sticky image and scrolling metadata | - | `2026-04-23` | `2026-04-23` | `origin/main` | opened from origin/main |
