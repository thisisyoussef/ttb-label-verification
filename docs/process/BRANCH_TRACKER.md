...
| `codex/TTB-000-cola-cloud-live-exclude` | `TTB-000` | `codex` | `draft-local` | exclude unreadable live COLA record 26107001000011 from live rotation and corpus refresh | - | `2026-04-23` | `2026-04-23` | `origin/main` | linked worktree: /Users/youss/Development/gauntlet/ttb-label-verification-cola-cloud-live-exclude |
