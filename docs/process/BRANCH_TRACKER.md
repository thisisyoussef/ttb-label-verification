...
| `codex/TTB-204-bold-heading-review` | `TTB-204` | `codex` | `ready-pr` | keep bold-only government warning heading misses in review so uncertain styling calls do not hard-fail the label | #126 | `2026-04-19` | `2026-04-19` | `origin/main` | published and auto-opened as PR #126 |
