...
| `codex/TTB-204-warning-pass-retune` | `TTB-204` | `codex` | `draft-local` | restore rightful government warning passes by relaxing exact-text and vote-conflict handling while preserving heading defects | - | `2026-04-19` | `2026-04-19` | `origin/main` | opened from origin/main |
