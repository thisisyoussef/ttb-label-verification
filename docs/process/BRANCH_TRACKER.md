...
| `codex/TTB-204-warning-tail-trim` | `TTB-204` | `codex` | `draft-local` | stop treating unrelated trailing label copy after the canonical warning as allowed extra warning messaging | - | `2026-04-23` | `2026-04-23` | `origin/main` | opened from origin/main |
