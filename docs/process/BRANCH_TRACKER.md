...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `chore/TTB-000-review-animation-closeout` | `TTB-000` | `chore` | `draft-local` | close merged tracker row for review animation stability fix | - | `2026-04-19` | `2026-04-19` | `origin/main` | opened from origin/main |
