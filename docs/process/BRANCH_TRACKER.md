...
| `codex/TTB-401-demo-recorder` | `TTB-401` | `codex` | `draft-local` | add a reproducible narrated product demo recorder and deterministic demo-mode helpers for single and batch walkthroughs | - | `2026-04-20` | `2026-04-20` | `origin/main` | opened from origin/main |
