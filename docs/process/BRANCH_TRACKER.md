...
| `codex/TTB-000-verify-tour-boundary` | `TTB-000` | `codex` | `draft-local` | fix the guided-tour spotlight boundary, collapse toolbench during tours, and replace the loud first-run help popup with a subtle launcher indicator | - | `2026-04-19` | `2026-04-19` | `origin/main` | opened from origin/main |
