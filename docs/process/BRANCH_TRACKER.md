...
| `codex/TTB-401-assessor-screenshots` | `TTB-401` | `codex` | `draft-local` | add evaluator screenshots and a step-by-step testing guide covering single review, toolbench, batch, and latency surfaces | - | `2026-04-19` | `2026-04-19` | `origin/main` | isolated clean screenshot worktree at `/Users/youss/Development/gauntlet/ttb-label-verification-ttb401-screenshots` |
