...
| `codex/TTB-401-mermaid-restore` | `TTB-401` | `codex` | `draft-local` | restore Mermaid-rendered docs and refocus README around assessor-facing architecture, refine, and latency | - | `2026-04-19` | `2026-04-19` | `origin/main` | opened from origin/main |
