...
export function ResultsPinnedColumn({
  ...
  return (
    <aside className="md:col-span-5 lg:col-span-4 flex min-h-0 flex-col overflow-y-auto border-r border-outline-variant/15 bg-surface-container-low">
      <div className="flex flex-col gap-4 p-4 lg:p-6 xl:p-8">
