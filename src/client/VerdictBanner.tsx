...
export function VerdictBanner({ verdict, counts, secondary }: VerdictBannerProps) {
  ...
  return (
    <section
      ...
      className={[
        'relative rounded-lg border-l-4 p-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between',
        skin.banner,
        skin.accent
      ].join(' ')}
    >
