...
import type { AnchorTrackResult } from '../anchors/anchor-field-track';
...
export async function buildVerificationReport(input: {
   ...
   */
  spiritsColocation?: import('../validators/spirits-colocation-check').SpiritsColocationResult | null;
  /**
