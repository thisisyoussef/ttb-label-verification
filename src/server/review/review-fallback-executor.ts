import type { AiProvider, ExtractionMode } from '../llm/ai-provider-policy';
import type { ReviewExtraction } from '../../shared/contracts/review';
import type { NormalizedReviewIntake } from './review-intake';
import type { ReviewExtractorContext } from '../extractors/review-extraction';
import type { ReviewLatencyCapture } from './review-latency';
import type { ReviewExtractorProvider } from '../extractors/review-provider-registry';
import {
  createUnavailableProviderFailure,
  fallbackWindowStillOpen,
  normalizeProviderRuntimeFailure
} from '../extractors/review-provider-failure';
