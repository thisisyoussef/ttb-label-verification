...
import { extractFieldsFromOcrText } from '../../src/server/extractors/ocr-field-extractor';
import { reconcileExtractionWithOcr } from '../../src/server/extractors/extraction-ocr-reconciler';
import { mergeOcrAndVlm, applyRegionOverrides } from '../../src/server/extractors/extraction-merge';
import {
  buildGovernmentWarningCheck,
  normalizeGovernmentWarningText
} from '../../src/server/validators/government-warning-validator';
import {
  computeWarningSimilarity,
  similarityToVote,
  type WarningSignalVote
} from '../../src/server/validators/government-warning-vote';
import { createConfiguredReviewExtractor } from '../../src/server/extractors/review-extractor-factory';
import { createNormalizedReviewIntake } from '../../src/server/review/review-intake';
import {
  runOcrPrepassOverLabels,
  runVlmRegionDetectionOverLabels,
  runWarningOcvOverLabels,
  runWarningOcrCrossCheckOverLabels
} from '../../src/server/extractors/multi-label-stages';
import { isOcrPrepassEnabled } from '../../src/server/extractors/ocr-prepass';
import { isRegionDetectionEnabled } from '../../src/server/extractors/vlm-region-detector';
