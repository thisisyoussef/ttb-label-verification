...
9. If the story changes prompt/model/tool-call or agentic LLM behavior, add `trace-brief.md`, run the local fixture-backed tuning loop, and record the winning evidence.
...
- `trace-brief.md` should define the tuning hypothesis, fixture slice, review focus, failure taxonomy, winning local evidence, and what changed between iterations.
