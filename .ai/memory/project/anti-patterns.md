...
- Splitting the Results left rail into a sticky image wrapper above separately scrolling metadata, which makes filenames and type metadata slide underneath the image panel during scroll
