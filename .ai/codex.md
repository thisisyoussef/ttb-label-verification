...
- `docs/process/TRACE_DRIVEN_DEVELOPMENT.md` for local fixture-backed prompt/model/tool-call tuning
...
- Keep trace-driven tuning local-only with approved fixtures or sanitized inputs. Do not add or depend on an external trace service.
